...
const menuItems = computed(() => [
  { id: 'mine', icon: 'calendar', label: 'Мои отпуска', visible: true },
  { id: 'department', icon: 'team', label: 'Отпуска подразделения', visible: isElevated.value },
  { id: 'manage', icon: 'manage', label: 'Управление отпусками', visible: isElevated.value },
  ...
  <div class="app-shell irlix-ui">
    ...
    <main class="workspace">
      ...
      <template v-else-if="workspace">
        ...
        <ManageAbsencesPage
          v-else-if="section === 'manage'"
          :departments="workspace.departments || []"
          :employees="workspace.employees || []"
          :can-create-for-employee="isManager || isPersonnelOfficer"
          :refresh-token="refreshToken"
          @action="handleAction"
          @error="notifyError"
          @changed="markChanged('Отсутствие сотрудника создано')"
        />
